...
class opParams:
  def __init__(self):
    ...
    VT = ValueTypes()
    self.fork_params = {'Camera_Offset': Param(0.06, VT.number, 'This will reposition your vehicle if there has a hugging issue'
                        ...
                        'LCA_Min_Speed': Param(25.0, VT.number, 'The minimum speed for an Lane Change Assist MPH/KPH'),}
